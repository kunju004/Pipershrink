    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginRight: 'auto' }}>
          ...
          <div>
            <div style={{ fontSize: 16, fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1 }}>Squeeze</div>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          ...
          <h1 style={{
            ...
            letterSpacing: '-2px', lineHeight: 1.05, marginBottom: '0.75rem',
          }}>
            Compress files<br />
            <span style={{
              color: tab.accent,
              textShadow: `0 0 40px ${tab.accent}44`,
        ...
        <div style={{
          ...
          background: 'var(--bg1)', borderRadius: 'var(--radius)',
          padding: 5, border: '1px solid var(--border)',
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 10 }}>
            {[
              { icon: '📄', title: 'Huffman Coding', body: 'Assigns shorter bit-codes to frequent characters. The same algorithm used inside ZIP, PNG, and MP3.', accent: '#3bf5d4' },
        ...
        <footer style={{
          ...
          <div style={{ fontSize: 12, color: 'var(--text3)', fontFamily: 'var(--font-mono)' }}>
            Built with Web APIs · No server · Converted from Python / Tkinter desktop app
          </div>
